# Statistics and Spreadsheet Coursework

This folder documents spreadsheet-based assignments and practice files from the Data Technology program.
...
- Scatter plots
- Pivot tables
- Basic data cleaning and spreadsheet formulas
...
| `Lab 13 Scatter Plots.xlsx` | Scatter plot and relationship visualization practice. |
| `Lab 14 Linear Regression.xlsx` | Linear regression practice using spreadsheet tools and charts. |
| `Assignment 05 Hypothesis Testing.xlsx` | Hypothesis testing assignment. |
